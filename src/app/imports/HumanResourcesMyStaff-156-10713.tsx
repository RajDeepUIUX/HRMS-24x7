    ...
    <div className="bg-[#ebeefd] h-[42px] relative shrink-0 w-full" data-name="Table Header">
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[4px] h-[42px] items-center px-[16px] py-[8px] relative w-full">
          <p className="basis-0 font-['Inter:Semi_Bold',sans-serif] font-semibold grow leading-[18px] min-h-px min-w-px not-italic relative shrink-0 text-[#101828] text-[12px]">Staff Name</p>
        </div>
      </div>
    </div>
  );
      ...
      <div className="absolute bottom-[-150%] left-0 right-[-150%] top-0">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 80 80">
          <g id="Avatar/Female 07">
            <path d={svgPaths.p174def80} fill="var(--fill-0, #D8DEFC)" id="path210" />
      ...
      <div className="absolute bottom-[-150%] left-0 right-[-150%] top-0">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 80 80">
          <g id="Avatar/Female 05">
            <path d={svgPaths.p11f647c0} fill="var(--fill-0, #D8DEFC)" id="path334" />
...
function Frame53() {
  return (
    <div className="basis-0 content-stretch flex flex-col grow items-start justify-center min-h-px min-w-px relative shrink-0">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#344054] text-[14px] w-full">Rekha Singhal</p>
    </div>
  );
}
      ...
      <div className="absolute bottom-[-150%] left-0 right-[-150%] top-0">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 80 80">
          <g id="Avatar/Female 08">
            ...
            <path d={svgPaths.p3d52b500} fill="url(#paint0_linear_156_10948)" id="path98" />
            <path d={svgPaths.p1eeac000} fill="url(#paint1_linear_156_10948)" id="path100" />
            ...
            <path d={svgPaths.p1dca3b40} fill="url(#paint2_linear_156_10948)" id="path124" />
          ...
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_156_10948" x1="10.0814" x2="74.2263" y1="79.9996" y2="49.9941">
              <stop stopColor="#13CDF8" />
              <stop offset="1" stopColor="#3A58EF" />
            </linearGradient>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_156_10948" x1="16.6357" x2="66.5623" y1="79.9978" y2="61.9451">
              <stop stopColor="#13CDF8" />
              <stop offset="1" stopColor="#3A58EF" />
            </linearGradient>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint2_linear_156_10948" x1="29.2741" x2="41.5399" y1="79.749" y2="78.7881">
              <stop stopColor="#13CDF8" />
              <stop offset="1" stopColor="#3A58EF" />
            </linearGradient>
          </defs>
  ...
  return (
    <div className="relative shrink-0 size-[32px]" data-name="Avatar/Male 03">
      <div className="absolute bottom-[-150%] left-0 right-[-150%] top-0">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 80 80">
          <g id="Avatar/Male 03">
            <path d={svgPaths.p1c2fb980} fill="var(--fill-0, #F2F4F7)" id="path254" />
            <path d={svgPaths.p6503300} fill="var(--fill-0, #101828)" id="path256" />
            <path d={svgPaths.p178f4200} fill="var(--fill-0, #4E69F1)" id="path258" />
            <path d={svgPaths.p3a7887c0} fill="var(--fill-0, #F97066)" id="path260" />
            <path d={svgPaths.p31bc1980} fill="var(--fill-0, #101828)" id="path262" />
            <path d={svgPaths.p18afb800} fill="var(--fill-0, #F97066)" id="path264" />
            <path d={svgPaths.p31c84b00} fill="var(--fill-0, #101828)" id="path266" />
            <path d={svgPaths.p2e6aef00} fill="var(--fill-0, #101828)" id="path268" />
            <path d={svgPaths.p9602440} fill="var(--fill-0, #101828)" id="path270" />
            <path d={svgPaths.p2214d300} fill="var(--fill-0, #101828)" id="path272" />
            <path d={svgPaths.p3f8cce00} fill="var(--fill-0, #101828)" id="path274" />
            <path d={svgPaths.p20513800} fill="var(--fill-0, #101828)" id="path276" />
            <path d={svgPaths.pd8c2300} fill="var(--fill-0, #101828)" id="path278" />
            <path d={svgPaths.p26689740} fill="var(--fill-0, #101828)" id="path280" />
            <path d={svgPaths.p2ce40000} fill="var(--fill-0, #101828)" id="path282" />
            <path d={svgPaths.p30e09400} fill="var(--fill-0, #F5D575)" id="path284" />
            <path d={svgPaths.p11e3d600} fill="var(--fill-0, #4E69F1)" id="path286" />
            <path d={svgPaths.p235a6500} fill="var(--fill-0, #4E69F1)" id="path288" />
            <path d={svgPaths.p295a6b00} fill="var(--fill-0, #F5D575)" id="path290" />
          </g>
        </svg>
      </div>
    </div>
...
function Frame62() {
  return (
    <div className="basis-0 content-stretch flex flex-col grow items-start justify-center min-h-px min-w-px relative shrink-0">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#344054] text-[14px] w-full">Ramesh Kumar</p>
    </div>
  );
}
...
function Frame63() {
  return (
    <div className="basis-0 content-stretch flex flex-col grow items-start justify-center min-h-px min-w-px relative shrink-0">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#344054] text-[14px] w-full">Sameer Shetty</p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[32px]" data-name="Avatar/Male 02">
      <div className="absolute bottom-[-150%] left-0 right-[-150%] top-0">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 80 80">
          <g id="Avatar/Male 02">
            <path d={svgPaths.p3cabb900} fill="var(--fill-0, #F2F4F7)" id="path450" />
            <path d={svgPaths.p33aeab00} fill="var(--fill-0, #D8DEFC)" id="path452" />
            <path d={svgPaths.p37c3af00} fill="var(--fill-0, #101828)" id="path454" />
            <path d={svgPaths.p5add3f0} fill="var(--fill-0, #F97066)" id="path456" />
            <path d={svgPaths.p29b6ef00} fill="var(--fill-0, #101828)" id="path458" />
            <path d={svgPaths.p1285ef00} fill="var(--fill-0, #F97066)" id="path460" />
            <path d={svgPaths.p3dd67cf0} fill="var(--fill-0, #101828)" id="path462" />
            <path d={svgPaths.p205bdc00} fill="var(--fill-0, #101828)" id="path464" />
            <path d={svgPaths.p7aca400} fill="var(--fill-0, #101828)" id="path466" />
            <path d={svgPaths.p19fc0a40} fill="var(--fill-0, #101828)" id="path468" />
            <path d={svgPaths.p2d321480} fill="var(--fill-0, #101828)" id="path470" />
            <path d={svgPaths.pc6565c0} fill="var(--fill-0, #101828)" id="path472" />
            <path d={svgPaths.p8dc1f00} fill="var(--fill-0, #101828)" id="path474" />
            <path d={svgPaths.p12355b80} fill="var(--fill-0, #101828)" id="path476" />
            <path d={svgPaths.p20a93480} fill="var(--fill-0, #9CABF7)" id="path478" />
            <path d={svgPaths.p1fee1280} fill="var(--fill-0, white)" id="path480" />
            <path d={svgPaths.p23d59680} fill="var(--fill-0, #101828)" id="path482" />
            <path d={svgPaths.p24d2c00} fill="var(--fill-0, #5D667B)" id="path484" />
            <path d={svgPaths.pb919e00} fill="var(--fill-0, #5D667B)" id="path486" />
            <path d={svgPaths.p297bc780} fill="var(--fill-0, #5D667B)" id="path488" />
            <path d={svgPaths.p282da000} fill="var(--fill-0, #5D667B)" id="path490" />
          </g>
        </svg>
      </div>
    </div>
...
function Frame64() {
  return (
    <div className="basis-0 content-stretch flex flex-col grow items-start justify-center min-h-px min-w-px relative shrink-0">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#344054] text-[14px] w-full">Rohit Shetty</p>
    </div>
  );
}
...
function TableHeader1() {
  return (
    <div className="bg-[#ebeefd] h-[42px] relative shrink-0 w-full" data-name="Table Header">
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[4px] h-[42px] items-center px-[16px] py-[8px] relative w-full">
          <p className="basis-0 font-['Inter:Semi_Bold',sans-serif] font-semibold grow leading-[18px] min-h-px min-w-px not-italic relative shrink-0 text-[#101828] text-[12px]">Level</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="h-[50px] relative shrink-0 w-full" data-name="Table Body">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[10px] h-[50px] items-center px-[16px] py-[12px] relative w-full">
          <p className="[white-space-collapse:collapse] basis-0 font-['Inter:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#344054] text-[14px] text-nowrap">Level 1</p>
        </div>
      </div>
    </div>
  );
...
function TableBody14() {
  return (
    <div className="h-[50px] relative shrink-0 w-full" data-name="Table Body">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[10px] h-[50px] items-center px-[16px] py-[12px] relative w-full">
          <p className="[white-space-collapse:collapse] basis-0 font-['Inter:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#344054] text-[14px] text-nowrap">Level 3</p>
        </div>
      </div>
    </div>
  );
...
function TableBody15() {
  return (
    <div className="h-[50px] relative shrink-0 w-full" data-name="Table Body">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[10px] h-[50px] items-center px-[16px] py-[12px] relative w-full">
          <p className="[white-space-collapse:collapse] basis-0 font-['Inter:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#344054] text-[14px] text-nowrap">Level 4</p>
        </div>
      </div>
    </div>
  );
...
function TableBody16() {
  return (
    <div className="h-[50px] relative shrink-0 w-full" data-name="Table Body">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[10px] h-[50px] items-center px-[16px] py-[12px] relative w-full">
          <p className="[white-space-collapse:collapse] basis-0 font-['Inter:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#344054] text-[14px] text-nowrap">Level 2</p>
        </div>
      </div>
    </div>
  );
...
function TableHeader2() {
  return (
    <div className="bg-[#ebeefd] h-[42px] relative shrink-0 w-full" data-name="Table Header">
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[4px] h-[42px] items-center px-[16px] py-[8px] relative w-full">
          <p className="basis-0 font-['Inter:Semi_Bold',sans-serif] font-semibold grow leading-[18px] min-h-px min-w-px not-italic relative shrink-0 text-[#1d2939] text-[12px]">{`Designation `}</p>
        </div>
      </div>
    </div>
  );
...
function TableBody17() {
  return (
    <div className="h-[50px] relative shrink-0 w-full" data-name="Table Body">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[10px] h-[50px] items-center px-[16px] py-[12px] relative w-full">
          <p className="[white-space-collapse:collapse] basis-0 font-['Inter:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#344054] text-[14px] text-nowrap">Sr. Tax Manager</p>
        </div>
      </div>
    </div>
  );
...
function TableBody18() {
  return (
    <div className="h-[50px] relative shrink-0 w-full" data-name="Table Body">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[10px] h-[50px] items-center px-[16px] py-[12px] relative w-full">
          <p className="[white-space-collapse:collapse] basis-0 font-['Inter:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#344054] text-[14px] text-nowrap">Audit Associate</p>
        </div>
      </div>
    </div>
  );
...
function TableBody19() {
  return (
    <div className="h-[50px] relative shrink-0 w-full" data-name="Table Body">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[10px] h-[50px] items-center px-[16px] py-[12px] relative w-full">
          <p className="[white-space-collapse:collapse] basis-0 font-['Inter:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#344054] text-[14px] text-nowrap">Sr. Accountant</p>
        </div>
      </div>
    </div>
  );
...
function TableBody20() {
  return (
    <div className="bg-white h-[50px] relative shrink-0 w-full" data-name="Table Body">
      <div aria-hidden="true" className="absolute border-[#f2f2f2] border-[0px_0px_1px] border-solid inset-0 pointer-events-none" />
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[10px] h-[50px] items-center px-[16px] py-[12px] relative w-full">
          <p className="[white-space-collapse:collapse] basis-0 font-['Inter:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#344054] text-[14px] text-nowrap">Sr. Accountant</p>
...
function TableHeader3() {
  return (
    <div className="bg-[#ebeefd] h-[42px] relative shrink-0 w-full" data-name="Table Header">
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[4px] h-[42px] items-center px-[16px] py-[8px] relative w-full">
          <p className="basis-0 font-['Inter:Semi_Bold',sans-serif] font-semibold grow leading-[18px] min-h-px min-w-px not-italic relative shrink-0 text-[#101828] text-[12px]">Joining Date</p>
        </div>
      </div>
    </div>
  );
...
function TableBody21() {
  return (
    <div className="h-[50px] relative shrink-0 w-full" data-name="Table Body">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[10px] h-[50px] items-center px-[16px] py-[12px] relative w-full">
          <p className="[white-space-collapse:collapse] basis-0 font-['Inter:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#344054] text-[14px] text-nowrap">Nov 12, 2024</p>
        </div>
      </div>
    </div>
  );
...
function TableHeader4() {
  return (
    <div className="bg-[#ebeefd] h-[42px] relative shrink-0 w-full" data-name="Table Header">
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[4px] h-[42px] items-center px-[16px] py-[8px] relative w-full">
          <p className="basis-0 font-['Inter:Semi_Bold',sans-serif] font-semibold grow leading-[18px] min-h-px min-w-px not-italic relative shrink-0 text-[#101828] text-[12px]">Engagement Type</p>
        </div>
      </div>
    </div>
  );
...
function TableBody22() {
  return (
    <div className="h-[50px] relative shrink-0 w-full" data-name="Table Body">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[10px] h-[50px] items-center px-[16px] py-[12px] relative w-full">
          <p className="[white-space-collapse:collapse] basis-0 font-['Inter:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#344054] text-[14px] text-nowrap">Regular Staffing</p>
        </div>
      </div>
    </div>
  );
...
function TableBody23() {
  return (
    <div className="h-[50px] relative shrink-0 w-full" data-name="Table Body">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[10px] h-[50px] items-center px-[16px] py-[12px] relative w-full">
          <p className="[white-space-collapse:collapse] basis-0 font-['Inter:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#344054] text-[14px] text-nowrap">Temporary Staffing</p>
        </div>
      </div>
    </div>
  );
...
function TableHeader5() {
  return (
    <div className="bg-[#ebeefd] h-[42px] relative shrink-0 w-full" data-name="Table Header">
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[4px] h-[42px] items-center px-[16px] py-[8px] relative w-full">
          <p className="basis-0 font-['Inter:Semi_Bold',sans-serif] font-semibold grow leading-[18px] min-h-px min-w-px not-italic relative shrink-0 text-[#101828] text-[12px]">Location</p>
        </div>
      </div>
    </div>
  );
...
function TableBody24() {
  return (
    <div className="h-[50px] relative shrink-0 w-full" data-name="Table Body">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[10px] h-[50px] items-center px-[16px] py-[12px] relative w-full">
          <p className="[white-space-collapse:collapse] basis-0 font-['Inter:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#344054] text-[14px] text-nowrap">Ahmedabad</p>
        </div>
      </div>
    </div>
  );
...
function TableBody25() {
  return (
    <div className="h-[50px] relative shrink-0 w-full" data-name="Table Body">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[10px] h-[50px] items-center px-[16px] py-[12px] relative w-full">
          <p className="[white-space-collapse:collapse] basis-0 font-['Inter:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#344054] text-[14px] text-nowrap">Kolkata</p>
        </div>
      </div>
    </div>
  );
...
function TableBody26() {
  return (
    <div className="h-[50px] relative shrink-0 w-full" data-name="Table Body">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[10px] h-[50px] items-center px-[16px] py-[12px] relative w-full">
          <p className="[white-space-collapse:collapse] basis-0 font-['Inter:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#344054] text-[14px] text-nowrap">Delhi</p>
        </div>
      </div>
    </div>
  );
...
function TableBody27() {
  return (
    <div className="h-[50px] relative shrink-0 w-full" data-name="Table Body">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[10px] h-[50px] items-center px-[16px] py-[12px] relative w-full">
          <p className="[white-space-collapse:collapse] basis-0 font-['Inter:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#344054] text-[14px] text-nowrap">Baroda</p>
        </div>
      </div>
    </div>
  );
...
function TableBody28() {
  return (
    <div className="h-[50px] relative shrink-0 w-full" data-name="Table Body">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[10px] h-[50px] items-center px-[16px] py-[12px] relative w-full">
          <p className="[white-space-collapse:collapse] basis-0 font-['Inter:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#344054] text-[14px] text-nowrap">Surat</p>
        </div>
      </div>
    </div>
  );
...
function TableBody29() {
  return (
    <div className="h-[50px] relative shrink-0 w-full" data-name="Table Body">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex gap-[10px] h-[50px] items-center px-[16px] py-[12px] relative w-full">
          <p className="[white-space-collapse:collapse] basis-0 font-['Inter:Regular',sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#344054] text-[14px] text-nowrap">Hydrabad</p>
        </div>
      </div>
    </div>
  );
...
function Status() {
  return (
    <div className="bg-[#ecfdf3] box-border content-stretch flex gap-[6px] items-center px-[8px] py-[4px] relative rounded-[4px] shrink-0" data-name="Status">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[18px] not-italic relative shrink-0 text-[#12b76a] text-[12px] text-center text-nowrap whitespace-pre">Active</p>
    </div>
  );
}
...
function Status1() {
  return (
    <div className="bg-[#f2f4f7] box-border content-stretch flex gap-[6px] items-center px-[8px] py-[4px] relative rounded-[4px] shrink-0" data-name="Status">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[18px] not-italic relative shrink-0 text-[#5d667b] text-[12px] text-center text-nowrap whitespace-pre">Inactive</p>
    </div>
  );
}
...
function FileText() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="FileText">
      <div className="absolute bottom-[-45%] left-0 right-[-35%] top-0">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 27 29">
          <g id="FileText">
            <path d={svgPaths.pff74c80} fill="var(--fill-0, #5D667B)" id="Vector" />
          </g>
        </svg>
      </div>
    </div>
            ...
            <div className="relative size-full">
              <div className="absolute inset-[-1.7%_-0.45px]">
                <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1 28">
                  <path d="M0.448665 0.448665V26.7977" id="Vector 1" stroke="url(#paint0_linear_156_10912)" strokeLinecap="round" strokeWidth="0.89733" />
                  <defs>
                    <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_156_10912" x1="0.948665" x2="0.948665" y1="0.44505" y2="26.8013">
        ...
        <div className="flex-none rotate-[90deg]">
          <div className="relative size-[3.589px]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 4 4">
              <circle cx="1.79466" cy="1.79466" fill="url(#paint0_linear_156_10819)" id="Ellipse 1" r="1.79466" />
              <defs>
                <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_156_10819" x1="1.79466" x2="1.79466" y1="-0.000492359" y2="3.58981">
                  <stop stopColor="#8A75FE" />
                  <stop offset="1" stopColor="#3A58EF" />
                </linearGradient>
              </defs>
...
function Header() {
  return (
    <div className="absolute bg-[#f2f4f7] box-border content-stretch flex h-[70px] items-center justify-between px-[16px] py-[20px] right-0 top-0 w-[1440px]" data-name="Header">
      <Component />
      <Frame83 />
    </div>
  );
    ...
    <div className="basis-0 bg-[#d8defc] grow min-h-px min-w-px relative rounded-[8px] shrink-0" data-name="Sidebar Sub Item">
      <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex gap-[10px] items-center justify-center px-[12px] py-[8px] relative w-full">
          <p className="basis-0 font-['Inter:Regular',sans-serif] font-normal grow leading-[24px] min-h-px min-w-px not-italic relative shrink-0 text-[#1d2939] text-[16px]">My Staff</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="absolute h-[699px] left-[calc(50%+692px)] top-[calc(50%+26.5px)] translate-x-[-50%] translate-y-[-50%] w-[8px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8 699">
        <g clipPath="url(#clip0_156_10717)" id="Frame 1686561816">
...
export default function HumanResourcesMyStaff() {
  return (
