...
function Frame2() {
  return (
    <div className="box-border content-stretch flex gap-[10px] items-start px-[16px] py-[8px] relative shrink-0">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#5d667b] text-[14px] text-nowrap whitespace-pre">Attendance</p>
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="box-border content-stretch flex gap-[10px] items-start px-[16px] py-[8px] relative shrink-0">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[#3a58ef] text-[14px] text-nowrap whitespace-pre">Attendance Request</p>
    </div>
  );
}
...
function HeadingSubHeading() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading & Sub Heading">
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[32px] not-italic relative shrink-0 text-[#101828] text-[24px] w-full">Attendance Request</p>
    </div>
  );
}
    ...
    <div className="relative shrink-0 size-[32px]" data-name="Avatar/Male 01">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g id="Avatar/Male 01">
          ...
          <path d={svgPaths.p1d8ab900} fill="var(--fill-0, #9CABF7)" id="path582" />
          ...
          <path d={svgPaths.p3b4fe780} fill="var(--fill-0, #101828)" id="path594" />
...
function Status() {
  return (
    <div className="bg-[#ecfdf3] box-border content-stretch flex gap-[6px] items-center px-[8px] py-[4px] relative rounded-[4px] shrink-0" data-name="Status">
      ...
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[18px] not-italic relative shrink-0 text-[#12b76a] text-[12px] text-center text-nowrap whitespace-pre">Present</p>
    </div>
  );
}
...
function Button1() {
  return (
    <div className="bg-[#ebeefd] box-border content-stretch flex gap-[8px] items-center justify-center overflow-clip px-[14px] py-[8px] relative rounded-[4px] shadow-[0px_1px_2px_0px_rgba(16,24,40,0.05)] shrink-0" data-name="Button">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#3a58ef] text-[14px] text-nowrap whitespace-pre">View Request</p>
    </div>
  );
}
    ...
    <div className="h-[14.731px] relative shrink-0 w-[124.928px]" data-name="Group">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 125 15">
        <g id="Group">
          ...
          <path d={svgPaths.p32c72580} fill="url(#paint0_linear_156_12959)" id="Vector_6" />
          <path d={svgPaths.p1e4e6800} fill="url(#paint1_linear_156_12959)" id="Vector_7" />
          <path d={svgPaths.p9324500} fill="url(#paint2_linear_156_12959)" id="Vector_8" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_156_12959" x1="88.0772" x2="88.0772" y1="0.101715" y2="14.6143">
            <stop stopColor="#13CDF8" />
            <stop offset="1" stopColor="#3A58EF" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_156_12959" x1="112.367" x2="98.0295" y1="5.86546" y2="8.77102">
            <stop stopColor="#6B35C5" />
            <stop offset="1" stopColor="#B188F3" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint2_linear_156_12959" x1="126.58" x2="113.127" y1="9.49823" y2="5.03857">
            <stop stopColor="#9E8EF7" />
            <stop offset="1" stopColor="#2C2CB0" />
          </linearGradient>
        </defs>
...
export default function HumanResourcesAttendanceManagementAttendanceRequest() {
  return (
    <div className="bg-[#f2f4f7] relative size-full" data-name="Human Resources > Attendance Management > Attendance Request">
      <Main />
      <Header />
