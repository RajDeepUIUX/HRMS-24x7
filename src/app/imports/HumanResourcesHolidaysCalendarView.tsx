...
function IconButton() {
  return (
    <div className="box-border content-stretch flex gap-[8px] items-center justify-center overflow-clip p-[8px] relative rounded-[4px] shrink-0" data-name="Icon Button">
      <CaretLeft />
    </div>
  );
}
...
function Frame2095585265() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0">
      <IconButton />
      <p className="font-['Inter:Medium',_sans-serif] font-medium leading-[24px] not-italic relative shrink-0 text-[#5d667b] text-[16px] text-center w-[100px]">December</p>
      <IconButton1 />
    </div>
  );
}
...
function TableHeader() {
  return (
    <div className="bg-[#ebeefd] box-border content-stretch flex gap-[4px] h-[42px] items-center justify-center px-[16px] py-[8px] relative shrink-0 w-[149.143px]" data-name="Table Header">
      <p className="basis-0 font-['Inter:Semi_Bold',_sans-serif] font-semibold grow leading-[18px] min-h-px min-w-px not-italic relative shrink-0 text-[#1d2939] text-[12px] text-center">Sun</p>
    </div>
  );
}
...
function TableHeader1() {
  return (
    <div className="bg-[#ebeefd] box-border content-stretch flex gap-[4px] h-[42px] items-center justify-center px-[16px] py-[8px] relative shrink-0 w-[149.143px]" data-name="Table Header">
      <p className="basis-0 font-['Inter:Semi_Bold',_sans-serif] font-semibold grow leading-[18px] min-h-px min-w-px not-italic relative shrink-0 text-[#1d2939] text-[12px] text-center">Mon</p>
    </div>
  );
}
...
function TableHeader2() {
  return (
    <div className="bg-[#ebeefd] box-border content-stretch flex gap-[4px] h-[42px] items-center justify-center px-[16px] py-[8px] relative shrink-0 w-[149.143px]" data-name="Table Header">
      <p className="basis-0 font-['Inter:Semi_Bold',_sans-serif] font-semibold grow leading-[18px] min-h-px min-w-px not-italic relative shrink-0 text-[#1d2939] text-[12px] text-center">Tue</p>
    </div>
  );
}
...
function TableHeader3() {
  return (
    <div className="bg-[#ebeefd] box-border content-stretch flex gap-[4px] h-[42px] items-center justify-center px-[16px] py-[8px] relative shrink-0 w-[149.143px]" data-name="Table Header">
      <p className="basis-0 font-['Inter:Semi_Bold',_sans-serif] font-semibold grow leading-[18px] min-h-px min-w-px not-italic relative shrink-0 text-[#1d2939] text-[12px] text-center">Wed</p>
    </div>
  );
}
...
function TableHeader4() {
  return (
    <div className="bg-[#ebeefd] box-border content-stretch flex gap-[4px] h-[42px] items-center justify-center px-[16px] py-[8px] relative shrink-0 w-[149.143px]" data-name="Table Header">
      <p className="basis-0 font-['Inter:Semi_Bold',_sans-serif] font-semibold grow leading-[18px] min-h-px min-w-px not-italic relative shrink-0 text-[#1d2939] text-[12px] text-center">Thu</p>
    </div>
  );
}
...
function TableHeader5() {
  return (
    <div className="bg-[#ebeefd] box-border content-stretch flex gap-[4px] h-[42px] items-center justify-center px-[16px] py-[8px] relative shrink-0 w-[149.143px]" data-name="Table Header">
      <p className="basis-0 font-['Inter:Semi_Bold',_sans-serif] font-semibold grow leading-[18px] min-h-px min-w-px not-italic relative shrink-0 text-[#1d2939] text-[12px] text-center">Fri</p>
    </div>
  );
}
...
function TableHeader6() {
  return (
    <div className="bg-[#ebeefd] box-border content-stretch flex gap-[4px] h-[42px] items-center justify-center px-[16px] py-[8px] relative shrink-0 w-[149.143px]" data-name="Table Header">
      <p className="basis-0 font-['Inter:Semi_Bold',_sans-serif] font-semibold grow leading-[18px] min-h-px min-w-px not-italic relative shrink-0 text-[#1d2939] text-[12px] text-center">Sat</p>
    </div>
  );
}

function Frame2095585268() {
  return (
...
function Component293() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[10px] h-[128.4px] items-end px-[16px] py-[12px] relative shrink-0 w-[149.143px]" data-name="Component 293">
      <div aria-hidden="true" className="absolute border-[#eaecf0] border-[0px_1px_1px_0px] border-solid inset-0 pointer-events-none" />
      <p className="font-['Inter:Regular',_sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#98a2b3] text-[14px] text-right w-full">30</p>
    </div>
  );
}
...
function Component299() {
  return (
    <div className="box-border content-stretch flex gap-[10px] h-[128.4px] items-start justify-end px-[16px] py-[12px] relative shrink-0 w-[149.143px]" data-name="Component 293">
      <div aria-hidden="true" className="absolute border-[#eaecf0] border-[0px_1px_1px_0px] border-solid inset-0 pointer-events-none" />
      <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic relative shrink-0 text-[#344054] text-[14px] text-right">01</p>
    </div>
  );
}
...
function Component300() {
  return (
    <div className="box-border content-stretch flex gap-[10px] h-[128.4px] items-start justify-end px-[16px] py-[12px] relative shrink-0 w-[149.143px]" data-name="Component 293">
      <div aria-hidden="true" className="absolute border-[#eaecf0] border-[0px_1px_1px_0px] border-solid inset-0 pointer-events-none" />
      <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic relative shrink-0 text-[#344054] text-[14px] text-right">02</p>
    </div>
  );
}
...
function Component296() {
  return (
    <div className="box-border content-stretch flex gap-[10px] h-[128.4px] items-start justify-end px-[16px] py-[12px] relative shrink-0 w-[149.143px]" data-name="Component 296">
      <div aria-hidden="true" className="absolute border-[#eaecf0] border-[0px_1px_1px_0px] border-solid inset-0 pointer-events-none" />
      <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic relative shrink-0 text-[#344054] text-[14px] text-right">03</p>
    </div>
  );
}
...
function Component301() {
  return (
    <div className="box-border content-stretch flex gap-[10px] h-[128.4px] items-start justify-end px-[16px] py-[12px] relative shrink-0 w-[149.143px]" data-name="Component 296">
      <div aria-hidden="true" className="absolute border-[#eaecf0] border-[0px_1px_1px_0px] border-solid inset-0 pointer-events-none" />
      <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic relative shrink-0 text-[#344054] text-[14px] text-right">04</p>
    </div>
  );
}
...
function Component302() {
  return (
    <div className="box-border content-stretch flex gap-[10px] h-[128.4px] items-start justify-end px-[16px] py-[12px] relative shrink-0 w-[149.143px]" data-name="Component 296">
      <div aria-hidden="true" className="absolute border-[#eaecf0] border-[0px_1px_1px_0px] border-solid inset-0 pointer-events-none" />
      <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic relative shrink-0 text-[#344054] text-[14px] text-right">05</p>
    </div>
  );
}
...
function Component303() {
  return (
    <div className="box-border content-stretch flex gap-[10px] h-[128.4px] items-start justify-end px-[16px] py-[12px] relative shrink-0 w-[149.143px]" data-name="Component 296">
      <div aria-hidden="true" className="absolute border-[#eaecf0] border-[0px_1px_1px_0px] border-solid inset-0 pointer-events-none" />
      <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic relative shrink-0 text-[#344054] text-[14px] text-right">06</p>
    </div>
  );
}
...
function Component304() {
  return (
    <div className="box-border content-stretch flex gap-[10px] h-[128.4px] items-start justify-end px-[16px] py-[12px] relative shrink-0 w-[149.143px]" data-name="Component 296">
      <div aria-hidden="true" className="absolute border-[#eaecf0] border-[0px_1px_1px_0px] border-solid inset-0 pointer-events-none" />
      <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic relative shrink-0 text-[#344054] text-[14px] text-right">07</p>
    </div>
  );
}
...
function Component305() {
  return (
    <div className="box-border content-stretch flex gap-[10px] h-[128.4px] items-start justify-end px-[16px] py-[12px] relative shrink-0 w-[149.143px]" data-name="Component 296">
      <div aria-hidden="true" className="absolute border-[#eaecf0] border-[0px_1px_1px_0px] border-solid inset-0 pointer-events-none" />
      <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic relative shrink-0 text-[#344054] text-[14px] text-right">08</p>
    </div>
  );
}
...
function Component306() {
  return (
    <div className="box-border content-stretch flex gap-[10px] h-[128.4px] items-start justify-end px-[16px] py-[12px] relative shrink-0 w-[149.143px]" data-name="Component 296">
      <div aria-hidden="true" className="absolute border-[#eaecf0] border-[0px_1px_1px_0px] border-solid inset-0 pointer-events-none" />
      <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic relative shrink-0 text-[#344054] text-[14px] text-right">09</p>
    </div>
  );
}
...
function Component295() {
  return (
    <div className="box-border content-stretch flex gap-[10px] h-[128.4px] items-start justify-end px-[16px] py-[12px] relative shrink-0 w-[149.143px]" data-name="Component 295">
      <div aria-hidden="true" className="absolute border-[#eaecf0] border-[0px_1px_1px_0px] border-solid inset-0 pointer-events-none" />
      <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic relative shrink-0 text-[#344054] text-[14px] text-right">10</p>
    </div>
  );
}
...
function Component307() {
  return (
    <div className="box-border content-stretch flex gap-[10px] h-[128.4px] items-start justify-end px-[16px] py-[12px] relative shrink-0 w-[149.143px]" data-name="Component 295">
      <div aria-hidden="true" className="absolute border-[#eaecf0] border-[0px_1px_1px_0px] border-solid inset-0 pointer-events-none" />
      <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic relative shrink-0 text-[#344054] text-[14px] text-right">11</p>
    </div>
  );
}
...
function Component308() {
  return (
    <div className="box-border content-stretch flex gap-[10px] h-[128.4px] items-start justify-end px-[16px] py-[12px] relative shrink-0 w-[149.143px]" data-name="Component 295">
      <div aria-hidden="true" className="absolute border-[#eaecf0] border-[0px_1px_1px_0px] border-solid inset-0 pointer-events-none" />
      <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic relative shrink-0 text-[#344054] text-[14px] text-right">12</p>
    </div>
  );
}
...
function Component309() {
  return (
    <div className="box-border content-stretch flex gap-[10px] h-[128.4px] items-start justify-end px-[16px] py-[12px] relative shrink-0 w-[149.143px]" data-name="Component 295">
      <div aria-hidden="true" className="absolute border-[#eaecf0] border-[0px_1px_1px_0px] border-solid inset-0 pointer-events-none" />
      <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic relative shrink-0 text-[#344054] text-[14px] text-right">13</p>
    </div>
  );
}
...
function Component310() {
  return (
    <div className="box-border content-stretch flex gap-[10px] h-[128.4px] items-start justify-end px-[16px] py-[12px] relative shrink-0 w-[149.143px]" data-name="Component 295">
      <div aria-hidden="true" className="absolute border-[#eaecf0] border-[0px_1px_1px_0px] border-solid inset-0 pointer-events-none" />
      <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic relative shrink-0 text-[#344054] text-[14px] text-right">14</p>
    </div>
  );
}
...
function Component311() {
  return (
    <div className="box-border content-stretch flex gap-[10px] h-[128.4px] items-start justify-end px-[16px] py-[12px] relative shrink-0 w-[149.143px]" data-name="Component 295">
      <div aria-hidden="true" className="absolute border-[#eaecf0] border-[0px_1px_1px_0px] border-solid inset-0 pointer-events-none" />
      <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic relative shrink-0 text-[#344054] text-[14px] text-right">15</p>
    </div>
  );
}
...
function Component312() {
  return (
    <div className="box-border content-stretch flex gap-[10px] h-[128.4px] items-start justify-end px-[16px] py-[12px] relative shrink-0 w-[149.143px]" data-name="Component 295">
      <div aria-hidden="true" className="absolute border-[#eaecf0] border-[0px_1px_1px_0px] border-solid inset-0 pointer-events-none" />
      <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic relative shrink-0 text-[#344054] text-[14px] text-right">16</p>
    </div>
  );
}
...
function Component297() {
  return (
    <div className="box-border content-stretch flex gap-[10px] h-[128.4px] items-start justify-end px-[16px] py-[12px] relative shrink-0 w-[149.143px]" data-name="Component 297">
      <div aria-hidden="true" className="absolute border-[#eaecf0] border-[0px_1px_1px_0px] border-solid inset-0 pointer-events-none" />
      <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic relative shrink-0 text-[#344054] text-[14px] text-right">17</p>
    </div>
  );
}
...
function Component313() {
  return (
    <div className="box-border content-stretch flex gap-[10px] h-[128.4px] items-start justify-end px-[16px] py-[12px] relative shrink-0 w-[149.143px]" data-name="Component 297">
      <div aria-hidden="true" className="absolute border-[#eaecf0] border-[0px_1px_1px_0px] border-solid inset-0 pointer-events-none" />
      <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic relative shrink-0 text-[#344054] text-[14px] text-right">18</p>
    </div>
  );
}
...
function Component314() {
  return (
    <div className="box-border content-stretch flex gap-[10px] h-[128.4px] items-start justify-end px-[16px] py-[12px] relative shrink-0 w-[149.143px]" data-name="Component 297">
      <div aria-hidden="true" className="absolute border-[#eaecf0] border-[0px_1px_1px_0px] border-solid inset-0 pointer-events-none" />
      <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic relative shrink-0 text-[#344054] text-[14px] text-right">19</p>
    </div>
  );
}
...
function Component315() {
  return (
    <div className="box-border content-stretch flex gap-[10px] h-[128.4px] items-start justify-end px-[16px] py-[12px] relative shrink-0 w-[149.143px]" data-name="Component 297">
      <div aria-hidden="true" className="absolute border-[#eaecf0] border-[0px_1px_1px_0px] border-solid inset-0 pointer-events-none" />
      <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic relative shrink-0 text-[#344054] text-[14px] text-right">20</p>
    </div>
  );
}
...
function Component316() {
  return (
    <div className="box-border content-stretch flex gap-[10px] h-[128.4px] items-start justify-end px-[16px] py-[12px] relative shrink-0 w-[149.143px]" data-name="Component 297">
      <div aria-hidden="true" className="absolute border-[#eaecf0] border-[0px_1px_1px_0px] border-solid inset-0 pointer-events-none" />
      <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic relative shrink-0 text-[#344054] text-[14px] text-right">21</p>
    </div>
  );
}
...
function Component317() {
  return (
    <div className="box-border content-stretch flex gap-[10px] h-[128.4px] items-start justify-end px-[16px] py-[12px] relative shrink-0 w-[149.143px]" data-name="Component 297">
      <div aria-hidden="true" className="absolute border-[#eaecf0] border-[0px_1px_1px_0px] border-solid inset-0 pointer-events-none" />
      <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic relative shrink-0 text-[#344054] text-[14px] text-right">22</p>
    </div>
  );
}
...
function Component318() {
  return (
    <div className="box-border content-stretch flex gap-[10px] h-[128.4px] items-start justify-end px-[16px] py-[12px] relative shrink-0 w-[149.143px]" data-name="Component 297">
      <div aria-hidden="true" className="absolute border-[#eaecf0] border-[0px_1px_1px_0px] border-solid inset-0 pointer-events-none" />
      <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic relative shrink-0 text-[#344054] text-[14px] text-right">23</p>
    </div>
  );
}
...
function Component294() {
  return (
    <div className="box-border content-stretch flex gap-[10px] h-[128.4px] items-start justify-end px-[16px] py-[12px] relative shrink-0 w-[149.143px]" data-name="Component 294">
      <div aria-hidden="true" className="absolute border-[#eaecf0] border-[0px_1px_1px_0px] border-solid inset-0 pointer-events-none" />
      <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic relative shrink-0 text-[#344054] text-[14px] text-right">24</p>
    </div>
  );
}

function CalanderSlots() {
  return (
    <div className="bg-[#f2f4f7] box-border content-stretch flex flex-col h-[128.4px] items-end justify-between px-[16px] py-[12px] relative shrink-0 w-[149.143px]" data-name="Calander Slots">
      <div aria-hidden="true" className="absolute border-[#eaecf0] border-[0px_1px_1px_0px] border-solid inset-0 pointer-events-none" />
      <p className="font-['Inter:Regular',_sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#344054] text-[14px] text-right w-full">25</p>
      <p className="font-['Inter:Regular',_sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#344054] text-[14px] w-full">Christmas</p>
    </div>
  );
}

function CalanderSlots1() {
  return (
    <div className="bg-[#f2f4f7] box-border content-stretch flex flex-col h-[128.4px] items-end justify-between px-[16px] py-[12px] relative shrink-0 w-[149.143px]" data-name="Calander Slots">
      <div aria-hidden="true" className="absolute border-[#eaecf0] border-[0px_1px_1px_0px] border-solid inset-0 pointer-events-none" />
      <p className="font-['Inter:Regular',_sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#344054] text-[14px] text-right w-full">26</p>
      <p className="font-['Inter:Regular',_sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#344054] text-[14px] w-full">Boxing Day</p>
    </div>
  );
}
...
function Component319() {
  return (
    <div className="box-border content-stretch flex gap-[10px] h-[128.4px] items-start justify-end px-[16px] py-[12px] relative shrink-0 w-[149.143px]" data-name="Component 294">
      <div aria-hidden="true" className="absolute border-[#eaecf0] border-[0px_1px_1px_0px] border-solid inset-0 pointer-events-none" />
      <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic relative shrink-0 text-[#344054] text-[14px] text-right">27</p>
    </div>
  );
}
...
function Component320() {
  return (
    <div className="box-border content-stretch flex gap-[10px] h-[128.4px] items-start justify-end px-[16px] py-[12px] relative shrink-0 w-[149.143px]" data-name="Component 294">
      <div aria-hidden="true" className="absolute border-[#eaecf0] border-[0px_1px_1px_0px] border-solid inset-0 pointer-events-none" />
      <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic relative shrink-0 text-[#344054] text-[14px] text-right">28</p>
    </div>
  );
}
...
function Component321() {
  return (
    <div className="box-border content-stretch flex gap-[10px] h-[128.4px] items-start justify-end px-[16px] py-[12px] relative shrink-0 w-[149.143px]" data-name="Component 294">
      <div aria-hidden="true" className="absolute border-[#eaecf0] border-[0px_1px_1px_0px] border-solid inset-0 pointer-events-none" />
      <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic relative shrink-0 text-[#344054] text-[14px] text-right">29</p>
    </div>
  );
}
...
function Component322() {
  return (
    <div className="box-border content-stretch flex gap-[10px] h-[128.4px] items-start justify-end px-[16px] py-[12px] relative shrink-0 w-[149.143px]" data-name="Component 294">
      <div aria-hidden="true" className="absolute border-[#eaecf0] border-[0px_1px_1px_0px] border-solid inset-0 pointer-events-none" />
      <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic relative shrink-0 text-[#344054] text-[14px] text-right">30</p>
    </div>
  );
}
...
function Component298() {
  return (
    <div className="box-border content-stretch flex gap-[10px] h-[128.4px] items-start justify-end px-[16px] py-[12px] relative shrink-0 w-[149.143px]" data-name="Component 298">
      <div aria-hidden="true" className="absolute border-[#eaecf0] border-[0px_1px_1px_0px] border-solid inset-0 pointer-events-none" />
      <p className="basis-0 font-['Inter:Regular',_sans-serif] font-normal grow leading-[20px] min-h-px min-w-px not-italic relative shrink-0 text-[#344054] text-[14px] text-right">31</p>
    </div>
  );
}
...
function Component323() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[10px] h-[128.4px] items-end px-[16px] py-[12px] relative shrink-0 w-[149.143px]" data-name="Component 298">
      <div aria-hidden="true" className="absolute border-[#eaecf0] border-[0px_1px_1px_0px] border-solid inset-0 pointer-events-none" />
      <p className="font-['Inter:Regular',_sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#98a2b3] text-[14px] text-right w-full">01</p>
    </div>
  );
}
...
function Component324() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[10px] h-[128.4px] items-end px-[16px] py-[12px] relative shrink-0 w-[149.143px]" data-name="Component 298">
      <div aria-hidden="true" className="absolute border-[#eaecf0] border-[0px_1px_1px_0px] border-solid inset-0 pointer-events-none" />
      <p className="font-['Inter:Regular',_sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#98a2b3] text-[14px] text-right w-full">02</p>
    </div>
  );
}
...
function Component325() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[10px] h-[128.4px] items-end px-[16px] py-[12px] relative shrink-0 w-[149.143px]" data-name="Component 298">
      <div aria-hidden="true" className="absolute border-[#eaecf0] border-[0px_1px_1px_0px] border-solid inset-0 pointer-events-none" />
      <p className="font-['Inter:Regular',_sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#98a2b3] text-[14px] text-right w-full">03</p>
    </div>
  );
}

function Frame2095585269() {
  return (
    <div className="basis-0 content-start flex flex-wrap grow items-start justify-between min-h-px min-w-px relative shrink-0 w-full">
      <Component293 />
      <Component299 />
      <Component300 />
      <Component296 />
...
function Frame2095585270() {
  return (
    <div className="basis-0 grow min-h-px min-w-px relative rounded-[8px] shrink-0 w-[1044px] z-[1]">
      <div className="content-stretch flex flex-col h-full items-start justify-between overflow-clip relative w-[1044px]">
        <Frame2095585268 />
        <Frame2095585269 />
      </div>
  ...
  return (
    <div className="relative shrink-0 size-[14.357px]" data-name="Sparkle">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 15">
        <g id="Sparkle">
          <path d={svgPaths.p606f80} fill="var(--fill-0, white)" id="Vector" opacity="0.2" />
...
export default function HumanResourcesHolidaysCalendarView() {
  return (
    <div className="bg-[#f2f4f7] relative size-full" data-name="Human Resources > Holidays > Calendar View">
      <Main />
      <Header />
